 ...
 *
 * Copyright © 2020, Mohamed Zumair "mhdzumair" <mhdzumair@gmail.com>
 *
 * Charger Control driver for MTK Switching Charger (Ported from Linear Charger)
 *
...
MODULE_AUTHOR("Varun Chitre <varun.chitre15@gmail.com>" + "Moahmed Zumair <mhdzumair@gmail.com>");
MODULE_DESCRIPTION("MTK Switching Charger control driver");
